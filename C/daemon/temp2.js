...
function statistics(){
	if(Stat){
		...
		stat_btns.innerHTML = "<h3>Отобразить интервалы времени с характеристиками:</h3><p>\n"+
			"<input type='button' OnClick='make_request(1);' value='Максимум'>&nbsp;&nbsp;&nbsp;\n"+
			"<input type='button' OnClick='make_request(2);' value='Минимум'>&nbsp;&nbsp;&nbsp;\n"+
			"<input type='button' OnClick='make_request(0);' value='Режим работы'><p>"+
